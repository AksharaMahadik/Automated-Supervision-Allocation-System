    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insert Exam Type
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Insert Exam Type
                    ...
                    <table class="table table-striped table-bordered table-hover"><!-- table table-striped table-bordered table-hover begin -->
                        ...
                        <tbody><!-- tbody begin -->
                            ...
                            <?php 
                                ...
                                $get_slots = "select * from exam_type ORDER BY
                                exam_type_title ASC";
                            ...
                            <tr><!-- tr begin -->
                                ...
                                <td> 
                                     ...
                                     <a href="index.php?exam_type_delete=<?php echo $slot_id; ?>">
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              $insert_exam_type = "insert into exam_type (exam_type_title) values ('$exam_type_title')";
              
              $run_exam_type = mysqli_query($con,$insert_exam_type);
              
              if($run_exam_type){
                  
                  echo "<script>alert('New Exam Type Has Been Inserted')</script>";
