...
<?php 
    ...
    if(isset($_GET['block_edit'])){
        ...
        $edit_block_id = $_GET['block_edit'];
        
        $edit_block_query = "select * from block_details where id='$edit_block_id'";
        
        $run_edit = mysqli_query($con,$edit_block_query);
        
        $row_edit = mysqli_fetch_array($run_edit);
        
        $class_room = $row_edit['class_room'];
    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Edit Block
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-pencil fa-fw"></i> Edit Block
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input value="Update Block" name="update" type="submit" class="form-control btn btn-primary">
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              $department_name = $_POST['department_name'];
                ...
                $update_block = "update block_details set class_room='$class_room',
                ...
                if($run_block){
                    ...
                    echo "<script>alert('Block Has Been Updated')</script>";
