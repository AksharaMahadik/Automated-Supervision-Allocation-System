...
<?php 
    ...
    if(isset($_GET['exam_timing_slot_edit'])){
        ...
        $edit_exam_timing_slot = $_GET['exam_timing_slot_edit'];
        
        $edit_exam_timing_slot_query = "select * from exam_slots where id ='$edit_exam_timing_slot'";
            ...
            <div class="panel-body"><!-- panel-body begin -->
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <select name="exam_date" class="form-control action">
            
                            <option value="<?php echo $exam_date;?>"><?php echo $exam_date;?></option>
...
<?php  
          ...
          if(isset($_POST['submit'])){
                ...
                $update_exam_detail = "update `exam_slots` set exam_type='$exam_type', exam_date='$exam_date',exam_session = '$exam_session',
