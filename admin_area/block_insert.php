    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insert Block
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Insert Block
...
<?php  
          ...
          if(isset($_POST['submit'])){
              ...
              $insert_block = "insert into block_details (class_room,capacity,department_name) 
              ...
              if($run_block){
                  ...
                  echo "<script>alert('New Block Has Been Inserted')</script>";
                  
                  echo "<script>window.open('index.php?block_insert','_self')</script>";
